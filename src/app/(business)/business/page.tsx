            ...
            <nav className='w-full items-center justify-between flex flex-row gap-4'>
                <form className='w-1/2'>   
                  ...
                  <div className="relative">
                    ...
                    <input type="search" className=" w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-full bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search..." required />
