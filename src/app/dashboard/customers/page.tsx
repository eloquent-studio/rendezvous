...
export default function Page() {
    return (
        <div className="flex flex-row w-full h-full">
            <div className="w-full md:w-[360px] bg-slate-300 h-full">
                <form className="m-4 my-3">
                ...
                <div className="mx-4 flex flex-row justify-between items-center">
                    ...
                    <div>
                        <button type="button" className="flex flex-row items-center text-[#087396] hover:text-[#81c0d4]   focus:ring-0 focus:outline-none font-medium px-5 py-2.5 text-center">
