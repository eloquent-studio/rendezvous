                  ...
                  >
                    ...
                    <div className="">
                      <div className="relative w-10 h-10 flex items-center justify-center bg-gray-100 rounded-full dark:bg-gray-600">
                        ...
                        <span className="top-0 left-7 absolute w-[18px] h-[18px] text-center flex justify-center items-center bg-green-400 border-2 border-white dark:border-gray-800 rounded-full text-xs ">
                          2
                        </span>
                      </div>
                    </div>
