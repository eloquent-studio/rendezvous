...
const serviceItems = [
  ...
  title: "Education",
  info: "Tutoring, Online Classes, Colleges & Universities",
  },
  {
    id: 2,
    title: "Photography",
...
const PopularServices = () => {
  return (
    <div className='max-w-screen-lg mx-auto p-4 lg:p-0 my-8'>
      <h1 className='text-lg font-medium text-start'><b className='italic mr-1'>Rendezvous</b>has the ability to serve almost any business segment</h1>
          ...
          className="w-full p-8">
              <div className="flex flex-col items-center gap-2">
                <div className='w-full flex flex-row items-center justify-center gap-2'>
                  <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d={item.svgPath}/></svg>
                  <h5 className="text-sm font-semibold">{item.title}</h5>
                </div>
                <span className="text-xs font-medium text-gray-500 text-center pt-1">{item.info}</span>
              </div>
          </div>
          ))}
      </div>
