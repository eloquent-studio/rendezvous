                ...
                <div className={`w-full md:w-[512px] lg:w-[512px] bg-gray-100 h-full`}>
                    <div className="m-4">
                        ...
                        <div className="relative">
                            ...
                            <input type="search" className="block w-full p-2 ps-9 text-xs font-medium text-gray-900 border border-gray-300 rounded bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search Name, Email..." />
                        </div>
                    </div>
                    <div className="flex flex-col px-4 py-2">
                        ...
                        <div className="w-full flex flex-row justify-between items-center">
                            ...
                            <button type="button" className="flex flex-row items-center text-[#087396] hover:text-[#81c0d4] focus:ring-0 focus:outline-none font-medium text-sm p-2.5 pr-0 text-center">
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8 2.75C8 2.47386 7.77614 2.25 7.5 2.25C7.22386 2.25 7 2.47386 7 2.75V7H2.75C2.47386 7 2.25 7.22386 2.25 7.5C2.25 7.77614 2.47386 8 2.75 8H7V12.25C7 12.5261 7.22386 12.75 7.5 12.75C7.77614 12.75 8 12.5261 8 12.25V8H12.25C12.5261 8 12.75 7.77614 12.75 7.5C12.75 7.22386 12.5261 7 12.25 7H8V2.75Z" fill="currentColor" fillRule="evenodd" clipRule="evenodd"></path></svg>
                    ...
                    <ul>
                        {
                            data.map((item: any, index: number) => <ButtonItem key={index} {...item} onClick={() => SetCIndex(index)} deleteClick={(event: any) => { event.stopPropagation(); SetDeleteModal(true); }} />)
                        }
                    </ul>
                </div>
                    ...
                    <div className="w-full">
                        <div className="border-gray-400 bg-white text-black flex flex-row rounded-lg p-2 px-2 mx-4 my-2">
                            ...
                            <div className="flex flex-col justify-evenly ml-2 px-2 font-medium">
                                ...
                                <div className="text-xs text-gray-700 ">{data[cIndex]?.email ?? ""}</div>
                            </div>
                        </div>
                    </div>
...
const Appointments = ({ userRendezvous = [] }) => {
    ...
    return <div className="relative overflow-x-auto shadow sm:rounded-lg">
        <table className="w-full text-sm text-left rtl:text-right text-gray-500">
            <tbody>
                {userRendezvous.map((rendezvous: any) => (
                    <tr
                        key={rendezvous.id}
                        className={`${rendezvous.isCancelled
