...
const NOTSELECTEDBUTTON =
  "rounded-full bg-slate-400 font-normal p-2 mx-4 flex items-center";
const SELECTEDBUTTON =
  "rounded-l-full bg-slate-100 font-normal p-2 ml-4 flex items-center";
...
export default function Tabbar({
  ...
  useEffect(() => {
    if (window.innerWidth > 768) SetSelectedBtn(0);
  }, []);

  return (
    <div className="flex flex-row w-full h-full">
      <div
        className={`w-full md:w-[320px] lg:w-[360px] bg-slate-300 h-full ${
          selectedBtn >= 0 && "hidden sm:block"
        }`}
      >
        <div className="">
          ...
          <div className="flex flex-col space-y-2">
            <button
              ...
              className={selectedBtn == 0 ? SELECTEDBUTTON : NOTSELECTEDBUTTON}
            >
              <svg
            ...
            <button
              ...
              className={selectedBtn == 1 ? SELECTEDBUTTON : NOTSELECTEDBUTTON}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="22"
                ...
                width="22"
              >
                <path d="M168.462-730.001v-59.998h623.076v59.998H168.462Zm1.539 560v-240h-44.616v-59.998l43.077-200h623.076l43.077 200v59.998h-44.616v240h-59.998v-240H549.999v240H170.001Zm59.998-59.998h260.002v-180.002H229.999v180.002Zm-43.385-240h586.772-586.772Zm0 0h586.772l-30.539-140.002H217.153l-30.539 140.002Z" />
              </svg>
            ...
            <button
              ...
              className={selectedBtn == 2 ? SELECTEDBUTTON : NOTSELECTEDBUTTON}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="22"
      ...
      <div
        className={`bg-slate-100 md:block w-full h-full ${
          selectedBtn >= 0 ? "block" : "hidden"
        }`}
      >
        <div className="w-full h-full p-2 md:p-4">
          {selectedBtn == 0 && (
            <ProfileSetting user={user}>
              <BackButton onClick={() => SetSelectedBtn(-1)} />
            </ProfileSetting>
          )}
          {selectedBtn == 1 && (
            <BusinessSetting user={user} updatedInfo={updatedInfo}>
              <BackButton onClick={() => SetSelectedBtn(-1)} />
            </BusinessSetting>
          )}
        </div>
